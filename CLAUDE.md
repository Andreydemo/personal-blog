...
- Design spec: `docs/superpowers/specs/2026-09-09-personal-blog-design.md`; what has been done and every identifier (DOIs, ORCID, profile IDs): `docs/journal/`; open items: `docs/launch-checklist.md`; growth routine and targets: `docs/traffic-plan.md`.
