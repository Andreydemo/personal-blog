...
## Companion code and technical report

The guard is published as an open-source Kotlin/JVM library, [ssrf-guard](https://github.com/Andreydemo/ssrf-guard) (Apache-2.0, [DOI 10.5281/zenodo.22697765](https://doi.org/10.5281/zenodo.22697765)): the URL policy, the address classifier including the IPv6 transition forms and the RFC 8215 local-use NAT64 prefix, the public-only resolver, and an OkHttp `Dns` adapter, with the test vectors below as its test suite. A [technical report](https://doi.org/10.5281/zenodo.22698040) with the threat model, design and evaluation is published on Zenodo (DOI 10.5281/zenodo.22698040) and ships with each release.

## A test set you can reuse

Should be rejected: `https://127.0.0.1/`, `https://10.0.0.1/`, `https://169.254.169.254/`, `https://[::1]/`, `https://[::ffff:10.0.0.1]/`, `https://[64:ff9b::a00:1]/`, `https://[64:ff9b:1::a00:1]/`, `https://10.0.0.1.nip.io/`, `https://localhost/`, `https://metadata.google.internal/`, `http://example.com/`, `https://example.com:8443/`, `https:///path`, `https://exa mple.com/`.
...
Technical report: Korkoshko, A. (2026). *Closing SSRF in customer-configurable webhooks: a four-layer guard with connect-time DNS pinning* (Technical report, v1.0). Zenodo. https://doi.org/10.5281/zenodo.22698040

Companion software: Korkoshko, A. (2026). *ssrf-guard: an SSRF guard for customer-supplied webhook URLs* (v0.1.0). Zenodo. https://doi.org/10.5281/zenodo.22697765
...
@techreport{korkoshko2026ssrfreport,
  author      = {Korkoshko, Andrii},
  title       = {Closing {SSRF} in customer-configurable webhooks: a four-layer guard with connect-time {DNS} pinning},
  year        = {2026},
  month       = sep,
  institution = {Zenodo},
  type        = {Technical report},
  number      = {v1.0},
  doi         = {10.5281/zenodo.22698040}
}

@software{korkoshko2026ssrfguard,
  author    = {Korkoshko, Andrii},
  title     = {ssrf-guard: an {SSRF} guard for customer-supplied webhook {URLs}},
  version   = {0.1.0},
  year      = {2026},
  publisher = {Zenodo},
  doi       = {10.5281/zenodo.22697765},
  url       = {https://github.com/Andreydemo/ssrf-guard}
}
```
